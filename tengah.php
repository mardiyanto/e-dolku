                    ...
                    <div id="accordion">
                        <div class="card card-primary">
                            ...
                            <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                <div class="card-body">
                                    <?php $sql = mysqli_query($koneksi, "SELECT * FROM produk ORDER BY id_produk DESC LIMIT 6");
					...
					";
                        ...
                        <div class="card card-danger">
                            ...
                            <div id="collapseTwo" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <?php $sql = mysqli_query($koneksi, "SELECT * FROM produk ORDER BY dibeli DESC LIMIT 6");
                                    while ($r = mysqli_fetch_array($sql)) {
                                        include "diskon_stok.php";
                                        echo "
	<div class='product-info'>
					...
					";
                        ...
                        <div class="card card-success">
                            ...
                            <div id="collapseThree" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <?php $sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE diskon != '0' ORDER BY id_produk DESC LIMIT 6");
                                    while ($r = mysqli_fetch_array($sql)) {
                                        include "diskon_stok.php";
                                        echo "
	<div class='product-info'>
