<?php 
$detail = mysqli_query($koneksi, "SELECT * FROM produk, kategori WHERE produk.id_kategori=kategori.id_kategori AND id_produk=$_GET[id_p]");
...
<div class="card border-ligh">
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item"><?php if ($dt['diskon'] == 0) { ?>
...
<?php } ?></strong></li>
  ...
  <?php
    ...
    if ($dt['stok'] == 0) {
        echo "<a href='#' class='btn btn-danger card-link'>Card link</a>";
    } else {
        echo "<a href='aksi.php?module=keranjang&act=tambah&id=" . $dt['id_produk'] . "' class='btn btn-success card-link'>Beli Produk</a>";
    }
