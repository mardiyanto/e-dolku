...
if(isset($_GET['bls']) && $_GET['bls'] == 'balas'){
?>
...
$komentar = mysqli_query($koneksi, "SELECT * FROM komentar WHERE id_prod=$_GET[id_p] AND id_komen=$_GET[id_km] ORDER BY id_komen DESC");
if(mysqli_num_rows($komentar) > 0){
    while($c = mysqli_fetch_array($komentar)){
        ...
        $balasan = mysqli_query($koneksi, "SELECT * FROM komentar WHERE id_prod=$_GET[id_p] AND jwb='1' and balas=$c[id_komen] ORDER BY id_komen DESC");
    ...
    ";
        ...
        echo "</div>";
        $komentar2 = mysqli_query($koneksi, "SELECT * FROM komentar WHERE id_prod=$_GET[id_p] AND balas=$c[id_komen] ORDER BY id_komen DESC");
        if(mysqli_num_rows($komentar2) > 0){
            while($c2 = mysqli_fetch_array($komentar2)){
                ...
                $balasan = mysqli_query($koneksi, "SELECT * FROM komentar WHERE id_prod=$_GET[id_p] AND jwb='1' and balas=$c2[id_komen] ORDER BY id_komen DESC");
                $jml = mysqli_num_rows($balasan);
                if($jml > 0){
                    echo "
                    <div class='garis_k2'>";
...
$komentar = mysqli_query($koneksi, "SELECT * FROM komentar WHERE id_prod=$_GET[id_p] AND jwb='0' ORDER BY id_komen DESC");
if(mysqli_num_rows($komentar) > 0){
    while($c = mysqli_fetch_array($komentar)){
        $tgl_k = tgl_indo($c['tgl']); 
