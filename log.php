...
if ($aksi == 'login') {
    ...
    mysqli_query($koneksi, "UPDATE kustomer SET nama_lengkap='$nama',email='$_POST[email]', password='$password', telpon='$_POST[HP]' WHERE id_kustomer='$_SESSION[kustomer]'");
    ...
    if ($ketemu < 1) {
        ...
        mysqli_query($koneksi, "INSERT INTO kustomer(nama_lengkap, ndeso, kd_pos, telpon, email_tamu, id_kota, alm_alt) 
VALUES('$_POST[NM]','$_POST[DESO]','$_POST[POS]','$_POST[HP]','$_POST[email]','$_POST[KC]','$_POST[ALMT]')");

        $id_kustomer = mysqli_insert_id($koneksi);

        mysqli_query($koneksi, "INSERT INTO orders(tgl_order,jam_order,id_kustomer,id_kota_o,m_pengiriman,m_pembayaran,ketbar,id_bank_o) 
    ...
    if ($ketemu < 1) {
        ...
        window.location=('javascript:history.go(-1)')</script>";
            ...
            mysqli_query($koneksi, "INSERT INTO orders(tgl_order,jam_order,id_kustomer,id_kota_o,m_pengiriman,m_pembayaran,ketbar,member,id_bank_o) 
