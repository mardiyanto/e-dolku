...
if ($module=='order' AND $act=='update'){
   ...
   if ($_POST['status_order']=='Lunas'){ 
      ...
      mysqli_query($koneksi, "UPDATE produk,orders_detail SET produk.stok=produk.stok-orders_detail.jumlah WHERE produk.id_produk=orders_detail.id_produk and orders_detail.id_orders='$_POST[id]'");
	  
	  // Update untuk menambahkan produk yang dibeli (best seller = produk yang paling laris)
      mysqli_query($koneksi, "UPDATE produk,orders_detail SET produk.dibeli=produk.dibeli+orders_detail.jumlah WHERE produk.id_produk=orders_detail.id_produk and orders_detail.id_orders='$_POST[id]'");

      // Update status order
      mysqli_query($koneksi, "UPDATE orders SET status_order='$_POST[status_order]', Ket='$_POST[Ket]'  where id_orders='$_POST[id]'");
