...
<?php
    $edit = mysqli_query($koneksi, "SELECT * FROM orders,
									   ...
									   kota,
									   bank
									   WHERE orders.id_kustomer=kustomer.id_kustomer and kota.id_kota=orders.id_kota_o AND bank.id_bank=orders.id_bank_o AND id_orders='" . $_GET['id'] . "'");
...
<form class='formoid-metro-cyan' style='background-color:#FFFFFF;font-size:14px;font-family:"Open Sans","Helvetica Neue","Helvetica",Arial,Verdana,sans-serif;color:#000000;max-width:80%;min-width:150px' enctype='multipart/form-data' method='post' action='aksi_konfirmasitamu.php?A=I'>
<br>
