...
<form method="post" action="aksi.php?module=keranjang&act=update">  
    <div class='keranjang'>
        <?php
        $edit = mysqli_query($koneksi, "SELECT * FROM orders, kustomer, kota, bank WHERE kota.id_kota=orders.id_kota_o AND bank.id_bank=orders.id_bank_o AND id_orders='$_GET[id]'");
        ...
        <table border=0 width=500 class='table'>
            <tr>
                ...
                <td> <strong> $r[kabupaten],$r[nama_kota]<br />
            ...
            <tr>
                ...
                <td> : <strong>$r[m_pengiriman]</strong></td>
            </tr>
            <tr>
                <td>Keterangan Barang</td>
                <td> : <strong>$r[ketbar]</strong></td>
            </tr>
            <tr>
                <td>Metode Pembayaran</td>
                <td> : <strong>$r[m_pembayaran]</strong></td>
            </tr>";
            if ($r['m_pembayaran'] == 'Bank Transfer') {
                echo "
                <tr>
                    <td>Pilihan Bank</td>
                    <td> : Nama Bank : <strong>$r[nm_bank]</strong><br />
